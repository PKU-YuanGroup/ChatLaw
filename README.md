...
![](https://raw.githubusercontent.com/PKU-YuanGroup/ChatLaw/main/images/ChatLaw_framework.jpg)
...
| 王某与李某系夫妻，二人带女儿外出旅游，发生车祸全部遇难，但无法确定死亡的先后时间。下列哪些选项是正确的？<br/>A．推定王某和李某先于女儿死亡 <br/>B．推定王某和李某同时死亡<br/>C．王某和李某互不继承<br/>D．女儿作为第一顺序继承人继承王某和李某的遗产 | A．推定王某和李某先于女儿死亡<br/>B．推定王某和李某同时死亡<br/>C．王某和李某互不继承<br/>D．女儿作为第一顺序继承人继承王某和李某的遗产 | 法律选择题 |
